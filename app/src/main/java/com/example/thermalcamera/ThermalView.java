...
public class ThermalView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(centerViewX - crossSize, centerViewY,
                centerViewX + crossSize, centerViewY, crosshairOutlinePaint);
        canvas.drawLine(centerViewX, centerViewY - crossSize,
                centerViewX, centerViewY + crossSize, crosshairOutlinePaint);
        // Inner
        canvas.drawLine(centerViewX - crossSize, centerViewY,
        ...
        drawTextWithOutline(canvas, maxLabel, maxViewX + 16f, maxViewY + 8f);
        ...
        drawTextWithOutline(canvas, minLabel, minViewX + 16f, minViewY + 8f);
        ...
        if (!Float.isNaN(tapTemp) && System.currentTimeMillis() - tapTime < 3000) {
            ...
            drawTextWithOutline(canvas, tapLabel, tapViewX + 16f, tapViewY + 8f);
        }
